...
export class V2NIMChatroomClient extends EventEmitter<V2NIMChatroomClientListener> {
  ...
  constructor(private sdk: any, instanceId?: number) {
    ...
    this.chatroomService = new V2NIMChatroomService(this.instance.getInstanceId(), sdk)
    this.chatroomQueueService = new V2NIMChatroomQueueService(this.instance.getInstanceId(), sdk)
    this.storageService = new V2NIMStorageService(this.instance.getInstanceId())
    this.chatroomSdk = new sdk.V2NIMChatroomSdk();
  }
  ...
  init(option: V2NIMInitOption): V2NIMError | null {
    return this.chatroomSdk.init(option)
  }
   ...
   */
  uninit(): void {
    return this.chatroomSdk.uninit()
  }
  ...
  destroyInstance(instanceId: number): void {
    return this.chatroomSdk.destroyInstance(instanceId)
  }
   ...
   * ```
   */
   getInstanceList(): Array<V2NIMChatroomClient> {
    const instanceList = this.chatroomSdk.getInstanceIdList()
   ...
   */
  destroyAll(): void {
    return this.chatroomSdk.destroyAll()
  }
